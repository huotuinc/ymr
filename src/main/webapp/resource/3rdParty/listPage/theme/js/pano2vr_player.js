...
function lc() {
    ...
    "undefined" !== typeof document.documentElement.style[g] ? "webkitPerspective" in document.documentElement.style ? (g = document.createElement("style"), x = document.createElement("div"), o = document.head || document.getElementsByTagName("head")[0], g.textContent = "@media (-webkit-transform-3d) {#ggswhtml5{height:5px}}", o.appendChild(g), x.id = "ggswhtml5", document.documentElement.appendChild(x), o = 5 === x.offsetHeight, g.parentNode.removeChild(g), x.parentNode.removeChild(x)) : o = m : o = u;
    return o
}
function mc() {
    var g;
...
function pano2vrPlayer(g) {
    ...
    function l(a) {
        for (var c = 0; c < r.length; c++) if (r[c].id == a) return r[c];
        for (c = 0; c < y.length; c++) if (y[c].id == a) return y[c];
        return n
    }
    function L(a) {
        try {
    ...
    function M(a) {
        try {
            ...
            a.$ = m;
            a.obj.addEventListener("ended",
            function () {
                if (0 < this.e) return this.e--,
                this.currentTime = 0,
                this.play(),
                m;
                this.$ = u
    ...
    function na(a) {
        ...
        try {
            ...
            if (-1 == c) {
                for (b = 0; b < r.length; b++) if (r[b].id == a.id && r[b].obj != n) {
                    try {
                        r[b].obj.pause()
                    } catch (d) {
                        $(d)
                    ...
                    try {
                        r[b].obj.parentElement.removeChild(r[b].obj),
                        delete r[b].obj,
                        r[b].obj = n
                    } catch (e) {
                        $(e)
                ...
                if ((1 == a.mode || 2 == a.mode || 3 == a.mode || 5 == a.mode) && 0 <= a.loop) a.obj.autoplay = m;
                0 <= c ? r[c] = a : r.push(a);
                0 < a.obj.childNodes.length && (C.appendChild(a.obj), a.obj.addEventListener("ended",
                function () {
                    if (0 < this.e) return this.e--,
                    this.currentTime = 0,
                    this.play(),
    ...
    function Ea() {
        Oc(Ea);
        var a = new Date;
        0 <= O && (Aa ? (aa = 0.4 * (pa - fb), ba = 0.4 * (qa - gb), fb += aa, gb += ba, Hb(aa, ba)) : (aa = 0.1 * -Na, ba = 0.1 * -Oa, Hb(0.1 * -Na, 0.1 * -Oa)), d.dirty = m);
        pb && (d.changeFov(0.4 * (V - t)), 0.0010 > Math.abs(V - t) / t && (pb = u), d.dirty = m);
        if (Ib && (0 != aa || 0 != ba) && 0 > O) aa *= 0.9,
        ba *= 0.9,
        0.1 > aa * aa + ba * ba ? ba = aa = 0 : (Hb(aa, ba), d.dirty = m);
        if (0 != Pa) {
            switch (Pa) {
                case 37:
                    d.changePan(1, m);
        ...
        if (hb) {
            ...
            Mb = a.getTime();
            d.dirty = m
        } else if (ca) if (c = a.getTime() - Ta, 0 < Nb && d.S && c >= 1E3 * Nb) {
            if (1 < Ua.length) {
                c = 1E3;
                do b = Ua[Math.floor(Math.random() * Ua.length)];
                while (c-- && b == nc);
                Ta = a.getTime();
                d.openNext("{" + b + "}")
            }
        ...
        t += H,
        d.dirty = m;
        else if (ib && 0 > O && a.getTime() - Mb > 1E3 * Ob && (ca = m, Ta = a.getTime(), H = K = B = 0), Ib && 0 == Pa && 0 > O && (0 != B || 0 != K || 0 != H)) B *= 0.9,
        K *= 0.9,
        H *= 0.9,
        q += B,
        p += K,
        d.changeFovLog(H),
        1.0E-4 > B * B + K * K + H * H && (H = K = B = 0),
        d.dirty = m;
        ...
        if (0 < y.length) for (c = 0; c < y.length; c++) y[c].$ && y[c].la != y[c].obj.currentTime && (y[c].la = y[c].obj.currentTime, !y[c].fa && 0 < y[c].obj.videoHeight && (y[c].fa = y[c].obj.videoWidth / y[c].obj.videoHeight));
        if (0 < R) {
            if (2 == R) for (c = 0; c < G.length; c++) a = G[c],
            "poly" == a.type && a.k != a.c && (a.k > a.c ? (a.c += 0.05, a.k < a.c && (a.c = a.k)) : (a.c -= 0.05, a.k > a.c && (a.c = a.k)), d.dirty = m);
            3 == R && ia != W && (ia > W ? (W += 0.05, ia < W && (W = ia)) : (W -= 0.05, ia > W && (W = ia)), d.dirty = m)
        }
        a = new da;
        a.X(q, p);
        for (c = 0; c < r.length + y.length; c++) if (b = c < r.length ? r[c] : y[c - r.length], b.obj) {
            var h;
            h = b.pan - q;
        ...
        d.dirty && (d.dirty = u, d.updatePanorama())
    }
    function Fa(a) {
    ...
    function cb(a) {
        S || (a.preventDefault(), pb = m, V = wb / Math.sqrt(event.scale), V > ja && (V = ja), V < ka && (V = ka), d.dirty = m, I())
    }
    function db(a) {
        Qb = m;
    ...
    function Ja(a) {
        if (!S) {
            ...
            if (0 <= a && 20 > a) {
                ...
                if (d.d) {
                    a = d.d;
                    for (h = u; a && a != d.control;) a.onclick && !h && (a.onclick(), h = m, e = u),
                    a = a.parentNode
                }
                ...
                if (700 > c - d.C && 0 <= a && 20 > a) {
                    ...
                    if (d.d) {
                        a = d.d;
                        for (h = u; a && a != d.control;) a.ondblclick && !h && (a.ondblclick(), h = m, e = u),
                        a = a.parentNode
                    }
                    d.C = 0
                } else d.C = c;
    ...
    function Ka(a) {
        ...
        if (!S) {
            ...
            if (0 <= O) {
                a.preventDefault();
                for (a = 0; a < c.length; a++) if (c[a].identifier == O) {
    ...
    function La(a) {
        ...
        if (!S) {
            a.preventDefault();
            if (0 > O && c[0] && (Tb = (new Date).getTime(), qc = c[0].pageX, rc = c[0].pageY, jb = c[0].pageX, kb = c[0].pageY, d.d = c[0].target, c[0].target == d.control && (a = c[0].pageX, b = c[0].pageY, Ub = a, Vb = b, pa = a, qa = b, fb = a, gb = b, O = c[0].identifier, I()), d.d)) {
                a = d.d;
            ...
            1 < c.length && (O = -5); !Qb && 2 == c.length && c[0] && c[1] && (wc = Math.sqrt((c[0].pageX - c[1].pageX) * (c[0].pageX - c[1].pageX) + (c[0].pageY - c[1].pageY) * (c[0].pageY - c[1].pageY)), wb = t);
            Oa = Na = 0
        }
    }
    function oa(a) {
    ...
    function ya(a) {
        ...
        if (!S && (a.preventDefault(), 0 <= O && ((a.which || 0 == a.which || 1 == a.which) && uc(a.pageX, a.pageY), I()), d.hotspot == d.emptyHotspot || "poly" == d.hotspot.type)) {
    ...
    function Cc(a) {
        ...
        e.bufferData(e.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), e.STATIC_DRAW)
    }
    function Dc() {
        var a, c;
        if (X) for (; 0 < X.length;) e.deleteTexture(X.pop());
        X = [];
        for (var b = 0; 6 > b; b++) c = e.createTexture(),
        c.L = n,
        c.K = n,
        c.Z = u,
        a = new Image,
        ...
        c.ta = a,
        a.addEventListener && a.addEventListener("load", Ab(c), u),
        ta[b] && (a = new Image, a.crossOrigin = "anonymous", a.src = Z(ta[b]), c.L = a, a.addEventListener && a.addEventListener("load", Ab(c), u), d.checkLoaded.push(a)),
        X.push(c);
    ...
    function Ab(a) {
        return function () {
            try {
                ...
                var c = u;
                a.K != n && a.K.complete ? (e.bindTexture(e.TEXTURE_2D, a), a.Z || (e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, e.RGBA, e.UNSIGNED_BYTE, a.K), c = a.Z = m)) : a.L != n && a.L.complete && (e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, e.RGBA, e.UNSIGNED_BYTE, a.L), c = m);
    ...
    function Nc(a) {
        ...
        d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),
        f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),
        k = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),
        b = b << 2 | d >> 4,
        d = (d & 15) << 4 | f >> 2,
        e = (f & 3) << 6 | k,
    ...
    function Pc(a, c) {
        ...
        var e = yb;
        e.enabled && (b.text = document.createElement("div"), d = "position:absolute;" + ("left: -" + c.w / 2 + "px;"), d = d + "top:  20px;" + ("width: " + c.w + "px;"), d = 0 == c.h ? d + "height: auto;" : d + ("height: " + c.h + "px;"), c.wordwrap ? d = d + "white-space: pre-wrap;" + ("width: " + c.w + "px;") : (d = 0 == c.h ? d + "width: auto;" : d + ("width: " + c.w + "px;"), d += "white-space: nowrap;"), d += N + "transform-origin: 50% 50%;", b.text.setAttribute("style", d + "visibility: hidden;border: 1px solid #000000;background-color: #ffffff;text-align: center;overflow: hidden;padding: 0px 1px 0px 1px;"), b.text.style.color = sa(e.W, e.V), b.text.style.backgroundColor = e.background ? sa(e.t, e.s) : "transparent", b.text.style.border = "solid " + sa(e.v, e.u) + " " + e.P + "px", b.text.style.borderRadius = e.O + "px", b.text.style.textAlign = "center", b.text.style.width = 0 < e.width ? e.width + "px" : "auto", b.text.style.height = 0 < e.height ? e.height + "px" : "auto", b.text.style.overflow = "hidden", b.text.innerHTML = c.title, b.__div.onmouseover = function () {
    ...
    d.Q = function () {
        return 1 * z / (2 * Math.tan(Math.PI / 180 * (d.getVFov() / 2)))
    };
    d.setViewerSize = function (a, c) {
        ...
        F.style.top = ha + "px";
        if ($a) try {
            la && (la.width = b, la.height = h),
            e && (e.ea = b, e.da = h, e.viewport(0, 0, b, h))
        } catch (g) {
            alert(g)
        }
        D.style.width = a + "px";
        ...
        Y.height = c;
        d.updatePanorama();
        d.divSkin && d.divSkin.ggUpdateSize && d.divSkin.ggUpdateSize(a, c)
    };
    ...
    d.setVFov = function (a) {
        ...
        switch (ic) {
            ...
            case 2:
                ...
                break;
            case 3:
                4 * z / 3 > A || (a = 180 * Math.atan(3 * A / (4 * z) * Math.tan(a * Math.PI / 180)) / Math.PI),
                t = 2 * a
        }
    };
    d.updatePanorama = function () {
        ...
        for (g = 0; g < G.length; g++) {
            ...
            if ("poly" == f.type) {
                ...
                h = mb(h, Lc);
                l = h = mb(h, Mc);
                if (0 < l.length) for (b = 0; b < l.length; b++) a = l[b],
                0.1 > a.a ? (k = -c / a.a, h = A / 2 + a.x * k, k = z / 2 + a.y * k) : k = h = 0,
                a.D = h,
                a.q = k;
                f.p = l
            }
        ...
        if (Y && (fc != R && (fc = R, Y.style.visibility = 0 < R ? "inherit" : "hidden"), 0 < R)) {
            P || (P = Y.getContext("2d"));
            if (P.width != A || P.height != z) P.width = A,
            P.height = z;
            P.clear ? P.clear() : P.clearRect(0, 0, Y.width, Y.height);
            a = 1;
            3 == R && (a = W);
            for (c = 0; c < G.length; c++) if (g = G[c], "poly" == g.type && (f = g.p, 2 == R && (a = g.c), P.fillStyle = sa(g.t, g.s * a), P.strokeStyle = sa(g.v, g.u * a), 0 < f.length)) {
                P.beginPath();
                for (j = 0; j < f.length; j++) v = f[j],
                0 == j ? P.moveTo(v.D, v.q) : P.lineTo(v.D, v.q);
                P.closePath();
                P.stroke();
                P.fill()
            }
        ...
        if ($a) {
            zb();
            if (A != F.offsetWidth || z != F.offsetHeight) A = parseInt(F.offsetWidth),
            z = parseInt(F.offsetHeight);
            Hc && (d.initWebGL(0), Ca());
            if (e) {
                ...
                c *= f;
                a = -c;
                g = -f; (h = Cb) || (h = new glMatrixArrayType(16));
                b = c - a;
                l = f - g;
                h[0] = 0.2 / b;
                h[1] = 0;
                ...
                for (v = 0; 6 > v; v++) ob(ab),
                kc(ab, -p * Math.PI / 180, [1, 0, 0]),
                kc(ab, (180 - q) * Math.PI / 180, [0, 1, 0]),
                4 > v ? kc(ab, -Math.PI / 2 * v, [0, 1, 0]) : kc(ab, Math.PI / 2 * (5 == v ? 1 : -1), [1, 0, 0]),
                e.bindBuffer(e.ARRAY_BUFFER, Zb),
                e.vertexAttribPointer(E.ca, 3, e.FLOAT, u, 0, 0),
                e.bindBuffer(e.ARRAY_BUFFER, $b),
                e.vertexAttribPointer(E.ba, 2, e.FLOAT, u, 0, 0),
                e.activeTexture(e.TEXTURE0),
                e.bindTexture(e.TEXTURE_2D, X[v]),
                e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, ac),
                e.uniform1i(E.ra, 0),
                e.uniformMatrix4fv(E.pa, u, ab),
                e.uniformMatrix4fv(E.aa, u, Cb),
            ...
            if (A != F.offsetWidth || z != F.offsetHeight) A = parseInt(F.offsetWidth),
            z = parseInt(F.offsetHeight),
            F.style[T + "OriginX"] = A / 2 + "px",
            F.style[T + "OriginY"] = z / 2 + "px",
            c = m;
            a = Math.round(d.Q());
            if (d.T != a || c) d.T = a,
            F.style[lb] = a + "px";
            if (ea && ma) ea.style[T] = "translate3d(" + A / 2 + "px," + z / 2 + "px," + a + "px)",
            ma.style[T] = "rotateX(" + Number(p).toFixed(10) + "deg)  rotateY(" + Number(-q).toFixed(10) + "deg)";
            else for (c = 0; 6 > c; c++) if (g = d.cubeFaces[c]) f = "translate3d(" + A / 2 + "px," + z / 2 + "px," + a + "px) ",
            f += "rotateX(" + Number(p).toFixed(10) + "deg)  rotateY(" + Number(-q).toFixed(10) + "deg) ",
            g.Y && (f += g.Y, g.style.transform = f)
        }
        Eb()
    };
    var E;
    d.initWebGL = function (a) {
        Hc = u;
        try {
            if (la = a ? a : document.createElement("canvas"), la.width = 100, la.height = 100, F.appendChild(la), (e = la.getContext("webgl")) || (e = la.getContext("experimental-webgl")), e) {
                e.ea = 500;
                e.da = 500;
    ...
    d.setPanTiltFov = function (a, c, b) {
        I();
        isNaN(a) || (q = a);
        isNaN(c) || (p = c); !isNaN(b) && 0 < b && 180 > b && (t = b);
        d.dirty = m
    };
    ...
    d.ga = function () {
        ...
        10);
        a.addEventListener ? (a.addEventListener("touchstart", La, u), a.addEventListener("touchmove", Ka, u), a.addEventListener("touchend", Ja, u), a.addEventListener("touchcancel", eb, u), a.addEventListener("gesturestart", db, u), a.addEventListener("gesturechange", cb, u), a.addEventListener("gestureend", bb, u), a.addEventListener("mousedown", Bc, u), a.addEventListener("mousemove", ya, u), document.addEventListener("mouseup", xa, u), a.addEventListener("mousedblclick", d.toggleFullscreen, u), a.addEventListener("mousewheel", oa, u), a.addEventListener("DOMMouseScroll", oa, u), document.addEventListener("keydown", Ia, u), document.addEventListener("keyup", Ha, u), window.addEventListener("orientationchange", U, u), window.addEventListener("resize", Ca, u), window.addEventListener("blur", Ga, u), C.addEventListener("webkitfullscreenchange", wa, u), document.addEventListener("mozfullscreenchange", wa, u), window.addEventListener("webkitfullscreenchange", wa, u)) : a.attachEvent && (a.attachEvent("onmousedown", Bc), a.attachEvent("onmousemove", ya), document.attachEvent("onmouseup", xa), a.attachEvent("onmousedblclick", d.toggleFullscreen), a.attachEvent("onmousewheel", oa), document.attachEvent("onkeydown", Ia), document.attachEvent("onkeyup", Ha), window.attachEvent("onresize", Ca), window.attachEvent("onblur", Ga));
        a.oncontextmenu = function (a) {
            void 0 === a && (a = window.event);
            return !a.ctrlKey && (a = "<<L>>", "U" != a.charAt(2)) ? (Da(), u) : m
        }
    };
    d.addHotspotElements = function () {
        for (var a = 0; a < G.length; a++) if ("point" == G[a].type && (G[a].obj = d.skinObj && d.skinObj.addSkinHotspot ? new d.skinObj.addSkinHotspot(G[a]) : new Pc(this, G[a]), G[a].obj && G[a].obj.__div)) {
            var c = D.firstChild;
    ...
    d.removeHotspots = function () {
        for (var a; 0 < G.length;) a = G.pop(),
        a.obj && (D.removeChild(a.obj.__div), delete a.obj),
        a.obj = n
    };
    ...
    d.createCube = function () {
        ...
        var e = 128;
        nb > e && (e = nb);
        for (b = 0; 6 > b; b++) c = document.createElement("img"),
        ...
        a += N + "transform-origin: 0 0;",
        a += N + "transform: ",
        a = 4 > b ? a + ("rotateY(" + -90 * b + "deg)") : a + ("rotateX(" + (4 == b ? -90 : 90) + "deg)"),
        a += " scale(" + Ya + ") translate3d(" + -e / 2 + "px," + -e / 2 + "px," + -e / 2 + "px);",
        c.setAttribute("style", a),
        ma.appendChild(c),
        d.cubeFaces.push(c),
        d.checkLoaded.push(c),
        "" != jc[b] && (c = document.createElement("img"), c.setAttribute("src", Z(jc[b])), a = "position:absolute;", a += "left: 0px;", a += "top: 0px;", a += "width: " + e / 1.1 + "px;", a += "height: " + e / 1.1 + "px;", a += "z-index: 100;", a += N + "transform-origin: 0 0;", a += N + "transform: ", a = 4 > b ? a + ("rotateY(" + -90 * b + "deg)") : a + ("rotateX(" + (4 == b ? -90 : 90) + "deg)"), a += " scale(" + Ya + ") translate3d(" + -e / 2.2 + "px," + -e / 2.2 + "px," + -e / 2.2 + "px);", c.setAttribute("style", a), c.style.opacity = 0, ma.appendChild(c), d.cubeFacesOverlay.push(c), d.checkLoaded.push(c))
    };
    d.ia = function () {
        var a;
        ma = ea = n;
        ...
        for (b = 0; 6 > b; b++) {
            ...
            g += " scale(" + Ya + ") translate3d(" + -e / 2 + "px," + -e / 2 + "px," + -e / 2 + "px)";
            a += g + ";";
            c.Y = g;
            c.setAttribute("style", a);
            F.appendChild(c);
    ...
    d.finalPanorama = function () {
        var a;
        if (Bb) for (a = 0; 6 > a; a++) d.cubeFaces[a].setAttribute("src", Z(Wa[a]))
    };
    d.setOverlayOpacity = function (a) {
        var c;
        if (Bb) for (c = 0; 6 > c; c++) d.cubeFacesOverlay[c] && d.cubeFacesOverlay[c].style && (d.cubeFacesOverlay[c].style.opacity = a)
    };
    d.removePanorama = function () {
        var a;
        if (Bb) {
            for (a = 0; a < d.cubeFaces.length; a++) d.cubeFaces[a].setAttribute("src", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAIAAABLbSncAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA5JREFUeNpiYBgeACDAAADIAAE3iTbkAAAAAElFTkSuQmCC"),
        ...
        if (e && X) for (; 0 < X.length;) e.deleteTexture(X.pop());
    ...
    d.readConfigXml = function (a) {
        ...
        if ("tour" == c.nodeName) {
            var a = "",
            b; (b = c.getAttributeNode("start")) && (a = b.nodeValue.toString());
            "" != d.startNode && (a = d.startNode, d.startNode = "");
            for (c = c.firstChild; c;) {
                b = "";
                if ("panorama" == c.nodeName && (b = c.getAttributeNode("id"))) b = b.nodeValue.toString(),
                "" == a && (a = b),
                Za[b] = c,
                Ua.push(b);
                c = c.nextSibling
    ...
    d.U = function (a) {
        ...
        c, b, h, g = 1E6; a;) {
            if ("view" == a.nodeName) {
                ...
                for (c = a.firstChild; c;) "start" == c.nodeName && (b = c.getAttributeNode("pan"), gc = q = Number(b ? b.nodeValue : 0), b = c.getAttributeNode("tilt"), hc = p = Number(b ? b.nodeValue : 0), b = c.getAttributeNode("fov"), tb = t = Number(b ? b.nodeValue : 70)),
                "min" == c.nodeName && (b = c.getAttributeNode("pan"), Sa = 1 * (b ? b.nodeValue : 0), b = c.getAttributeNode("tilt"), va = 1 * (b ? b.nodeValue : -90), b = c.getAttributeNode("fov"), ka = 1 * (b ? b.nodeValue : 5), 1.0E-8 > ka && (ka = 1.0E-8)),
                "max" == c.nodeName && (b = c.getAttributeNode("pan"), Ra = 1 * (b ? b.nodeValue : 0), b = c.getAttributeNode("tilt"), ua = 1 * (b ? b.nodeValue : 90), b = c.getAttributeNode("fov"), ja = 1 * (b ? b.nodeValue : 120), 180 <= ja && (ja = 179.9)),
                c = c.nextSibling
            }
            "autorotate" == a.nodeName && ((b = a.getAttributeNode("speed")) && (ra = 1 * b.nodeValue), (b = a.getAttributeNode("delay")) && (Ob = 1 * b.nodeValue), (b = a.getAttributeNode("returntohorizon")) && (sb = 1 * b.nodeValue), (b = a.getAttributeNode("nodedelay")) && (Nb = 1 * b.nodeValue), Db && 0 != ra && (ca = ib = m, Ta = (new Date).getTime()));
            "input" == a.nodeName && (h || (h = a));
            if (h) for (c = 0; 6 > c; c++) b = h.getAttributeNode("prev" + c + "url"),
            ta[c] = b ? new String(b.nodeValue) : "";
            "altinput" == a.nodeName && (c = 0, (b = a.getAttributeNode("screensize")) && (c = 1 * b.nodeValue), 0 < c && c >= d.getMaxScreenResolution() && c < g && (g = c, h = a));
            "control" == a.nodeName && Db && ((b = a.getAttributeNode("simulatemass")) && (Ib = 1 == b.nodeValue), (b = a.getAttributeNode("locked")) && (S = 1 == b.nodeValue), b && (vb = 1 == b.nodeValue), (b = a.getAttributeNode("lockedmouse")) && (S = 1 == b.nodeValue), (b = a.getAttributeNode("lockedkeyboard")) && (vb = 1 == b.nodeValue), (b = a.getAttributeNode("lockedwheel")) && (Wb = 1 == b.nodeValue), (b = a.getAttributeNode("invertwheel")) && (xc = 1 == b.nodeValue), (b = a.getAttributeNode("speedwheel")) && (yc = 1 * b.nodeValue), (b = a.getAttributeNode("invertcontrol")) && (Aa = 1 == b.nodeValue), (b = a.getAttributeNode("dblclickfullscreen")) && (Sb = 1 == b.nodeValue));
            "overlay" == a.nodeName && ((b = a.getAttributeNode("blendspeed")) && (Va = 1 * b.nodeValue), (b = a.getAttributeNode("auto")) && (oc = 1 == b.nodeValue), (b = a.getAttributeNode("delay")) && (pc = 1 * b.nodeValue));
            if ("hotspots" == a.nodeName) for (c = a.firstChild; c;) {
                if ("label" == c.nodeName) {
                    var f = yb;
                    ...
                    if (b = c.getAttributeNode("background")) f.background = 1 == b.nodeValue;
                ...
                "polystyle" == c.nodeName && ((b = c.getAttributeNode("mode")) && (R = 1 * b.nodeValue), (b = c.getAttributeNode("bordercolor")) && (bc = 1 * b.nodeValue), (b = c.getAttributeNode("backgroundcolor")) && (dc = 1 * b.nodeValue), (b = c.getAttributeNode("borderalpha")) && (cc = 1 * b.nodeValue), (b = c.getAttributeNode("backgroundalpha")) && (ec = 1 * b.nodeValue));
                ...
                b = c.getAttributeNode("pan"), f.pan = 1 * (b ? b.nodeValue : 0), b = c.getAttributeNode("tilt"), f.tilt = 1 * (b ? b.nodeValue : 0), (b = c.getAttributeNode("url")) && (f.url = b.nodeValue.toString()), (b = c.getAttributeNode("target")) && (f.target = b.nodeValue.toString()), (b = c.getAttributeNode("title")) && (f.title = b.nodeValue.toString()), (b = c.getAttributeNode("id")) && (f.id = b.nodeValue.toString()), (b = c.getAttributeNode("skinid")) && (f.skinid = b.nodeValue.toString()), (b = a.getAttributeNode("width")) && (f.w = b.nodeValue.toString()), (b = a.getAttributeNode("height")) && (f.h = b.nodeValue.toString()), (b = a.getAttributeNode("wordwrap")) && (f.wordwrap = 1 == b.nodeValue), G.push(f));
                if ("polyhotspot" == c.nodeName) {
                    f = {
                        type: "poly",
                        url: "",
                        target: "",
                        ...
                        c: 0,
                        k: 0
                    }; (b = c.getAttributeNode("url")) && (f.url = b.nodeValue.toString()); (b = c.getAttributeNode("target")) && (f.target = b.nodeValue.toString()); (b = c.getAttributeNode("title")) && (f.title = b.nodeValue.toString()); (b = c.getAttributeNode("id")) && (f.id = b.nodeValue.toString());
                    f.v = bc;
                    f.t = dc;
                    f.u = cc;
                    f.s = ec;
            ...
            if ("sounds" == a.nodeName || "media" == a.nodeName) for (c = a.firstChild; c;) {
                if ("sound" == c.nodeName) {
                    k = {
                        id: "",
                        url: "",
                    ...
                    if (b = c.getAttributeNode("id")) k.id = b.nodeValue.toString(); (b = c.getAttributeNode("url")) && k.url.push(b.nodeValue.toString());
                    ...
                    for (f = c.firstChild; f;) "source" == f.nodeName && (b = f.getAttributeNode("url")) && k.url.push(b.nodeValue.toString()),
                    f = f.nextSibling;
                    na(k)
                }
                if ("video" == c.nodeName) {
                ...
                if ("image" == c.nodeName) {
                    ...
                    for (f = c.firstChild; f;) {
                        if ("source" == f.nodeName && (b = f.getAttributeNode("url"))) k.url = b.nodeValue.toString();
                        f = f.nextSibling
                    }
                    L(k)
                }
        ...
        if (h) {
            for (c = 0; 6 > c; c++) (b = h.getAttributeNode("tile" + c + "url")) && (Wa[c] = new String(b.nodeValue)),
            b = h.getAttributeNode("tile" + c + "url1"),
            jc[c] = b ? new String(b.nodeValue) : "";
            for (c = 0; 6 > c; c++) (b = h.getAttributeNode("prev" + c + "url")) && (ta[c] = new String(b.nodeValue)); (b = h.getAttributeNode("tilesize")) && (nb = 1 * b.nodeValue); (b = h.getAttributeNode("tilescale")) && (Ya = 1 * b.nodeValue)
        }
        $a ? e && (Cc(Ya), Dc()) : (Bb = m, 0 <= navigator.userAgent.indexOf("MSIE") ? d.ia() : d.createCube(), d.T = 0);
    ...
    d.openNext = function (a, c) {
        ...
        qb = 0;
        d.skinObj && d.skinObj.hotspotProxyOut && d.skinObj.hotspotProxyOut(d.hotspot.id);
        ...
        if ("{" == a.charAt(0)) if (e = a.substr(1, a.length - 2), Za[e]) d.U(Za[e]),
        o(a);
        else {
            $("invalid node id: " + e);
            return
        } else d.readConfigUrl(a);
        "" != b && (e = b.split("/"), 0 < e.length && d.setPan(Number(e[0])), 1 < e.length && d.setTilt(Number(e[1])), 2 < e.length && d.setFov(Number(e[2])));
        I()
    };
    ...
    d.getNodeUserdata = function (a) {
        ...
        if (a = Za[a]) for (a = a.firstChild; a;) {
